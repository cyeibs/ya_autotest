...
- В папке test/testplane есть файл constants.js - в нем необходимо изменять BUG_ID для тестирования учебных багов,
  либо запускать среду изначально передавая BUG_ID
- Реализованы только интеграционные тесты, тестирующие функциональные требования, исходя из пользовательского опыта
